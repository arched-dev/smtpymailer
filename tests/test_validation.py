...
class TestValidation(unittest.TestCase):
    ...
    #     self.assertFalse(
    #         is_ip_in_network(
    #             "2001:0db8:85a3:0000:0000:8a2e:0370:7335", "2001:0db8::/32"
    #         )
    #     )

    def test_invalid_ip(self):
        self.assertFalse(is_ip_in_network("not-a-valid-ip", "192.168.1.0/24"))

    def test_invalid_network(self):
        self.assertFalse(is_ip_in_network("192.168.1.1", "not-a-valid-network"))

    def test_empty_string_ip(self):
        self.assertFalse(is_ip_in_network("", "192.168.1.0/24"))

    def test_empty_string_network(self):
        self.assertFalse(is_ip_in_network("192.168.1.1", ""))
